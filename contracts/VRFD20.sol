...
contract VRFD20 is VRFConsumerBase, ConfirmedOwner(msg.sender) {
     ...
     * 
     Debe verificar si el contrato tiene suficiente LINK para pagar el oráculo.
         - Comprueba si los dados ya se han tirado, ya que cada tirada solo se puede asignar a una sola casa.
         - Solicitar aleatoriedad
         - Almacene el requestId y la dirección del jugador (roller).
         - Emite un evento para indicar que el dado está rodando.
     */
